...
GLvoid drawScene()
{
	...
	glUniform3fv(objColorLocation, 1, (float*)&objColor);
	modelTransform = Mercury_rotate * glm::translate(glm::mat4(1.0f), glm::vec3(-10.0, 10.0, 0)) * glm::scale(glm::mat4(1.0f), glm::vec3(0.2f, 0.2f, 0.2f));
	glUniformMatrix4fv(modelTransformLocation, 1, GL_FALSE, glm::value_ptr(modelTransform));
	...
	glUniform3fv(objColorLocation, 1, (float*)&objColor);
	modelTransform = Venus_rotate * glm::translate(glm::mat4(1.0f), glm::vec3(-25.0, 10.0, 0)) * glm::scale(glm::mat4(1.0f), glm::vec3(0.3f, 0.3f, 0.3f));
	glUniformMatrix4fv(modelTransformLocation, 1, GL_FALSE, glm::value_ptr(modelTransform));
	glDrawElements(GL_TRIANGLES, Sphere.indexCount, GL_UNSIGNED_INT, 0);
	...
	glUniform3fv(objColorLocation, 1, (float*)&objColor);
	modelTransform = Earth_rotate * glm::translate(glm::mat4(1.0f), glm::vec3(-40.0, 10.0, 0)) * glm::scale(glm::mat4(1.0f), glm::vec3(0.4f, 0.4f, 0.4f));
	glUniformMatrix4fv(modelTransformLocation, 1, GL_FALSE, glm::value_ptr(modelTransform));
	glDrawElements(GL_TRIANGLES, Sphere.indexCount, GL_UNSIGNED_INT, 0);
